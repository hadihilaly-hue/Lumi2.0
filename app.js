...
import { MENLO_CURRICULUM, SUBJECTS, SUBJECT_IDS } from './js/data.js';
...
import { activeDropdownEl, addLongPress, clearSearch, closeOpenMenu, renderSearchDropdown, renderSidebar, showInlineConfirm } from './js/sidebar.js';
import { $, S, SB, _currentProjId, _introShownFor, _saveIntroShown, attachPreview, currentUser, fileInput, messagesEl, msgInput, pendingAttachment, sbSearch, sendBtn, setCurrentProjId, setCurrentUser, setPendingAttachment, themeToggle } from './js/state.js';
...
import { TEACHER_EMAIL_MAP, _profileCache, fetchTeacherProfileLambda, getTeacherProfile, loadWorkSampleImages, preloadProfileStatuses, rdsFetch } from './js/teachers.js';
