...
import { buildCompanionSystem, buildTutorSystem, setSidebarUserSubtitle, teacherDisplayName, teacherInitials } from './js/prompts.js';
import { checkSemesterBanner, initScheduleSetup } from './js/schedule.js';
import { activeDropdownEl, addLongPress, closeOpenMenu, renderSearchDropdown, renderSidebar, showInlineConfirm } from './js/sidebar.js';
import { $, S, SB, _currentProjId, attachPreview, currentUser, fileInput, messagesEl, msgInput, pendingAttachment, sbSearch, sendBtn, setCurrentProjId, setCurrentUser, setPendingAttachment, themeToggle } from './js/state.js';
import { deleteConvFromSupabase, genId, getConvs, getSchedule, loadConvsFromSupabase, loadProfileFromSupabase, loadTestModeSchedule, migrateOldData, saveConvs, saveCurrentConv, syncConvToSupabase } from './js/storage.js';
import { TEACHER_EMAIL_MAP, _profileCache, fetchTeacherProfileLambda, preloadProfileStatuses, rdsFetch } from './js/teachers.js';
import { autoGrow, closeSettings, closeSidebar, escHtml, openSettings, openSidebar, showToast, updateSendBtn } from './js/ui.js';
import { _addSpeakerBtn, initVoice, wireVoiceListeners } from './js/voice.js';
